...
class TinderBot():
    ...
    def login(self):
        ...
        sleep(2)
        self.driver.find_element_by_xpath('//body').send_keys(Keys.F12)
        sleep(2)
    ...
    def dislike(self):
        dislike_btn = self.driver.find_element_by_xpath('//*[@id="content"]/div/div[1]/div/div/main/div/div[1]/div/div[2]/button[1]/span/svg')
        dislike_btn.click()
    ...
    def close_popup(self):
        ...
        popup_3.click()
#//*[@id="modal-manager"]/div/div/div/div/div[2]/div[3]/form/textarea
#//*[@id="modal-manager"]/div/div/div/div/div[2]/div[3]/form/button/span
